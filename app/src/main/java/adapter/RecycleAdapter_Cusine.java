...
import com.wolfsoft.propertyui.FirstLoginActivity;
...
Context context;
    ...
    public RecycleAdapter_Cusine(FirstLoginActivity mainActivityContacts, List<BeanClassForCusine> moviesList) {
